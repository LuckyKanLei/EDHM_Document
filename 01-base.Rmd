...
**Step** is special unit in EDHM, in EDHM the time serise is divided into many equal time interval, one time interval is a *Step*, the other units are given by [UCUM](https://ucum.org/trac).
