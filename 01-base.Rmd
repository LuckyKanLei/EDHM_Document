...
In EDHM a **PROCESS** is the mapping from those hydrological processes in a digital from, at the same time it's also the group (set) name of the some **MODULE**s those haven the same functions and same aims, and a **MODULE** is the definite method of a **PROCESS**, it can also undersatnd as: 
