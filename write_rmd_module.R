...
write_Rmd_Module <- function(module_name, file_name){
  ...
  string17 = 'P_'
  string18 = ' <- data.frame(Paramter = P_Name, Min = P_min, Max = P_max)\n'
  ...
  string <- paste0('### ', module_name, '\n\n',
         ...
         string2, string07, module_name, string3, 'InData', string4,
         string5,
         string0, string17, module_name, string1,
         string2, string17, module_name, string3, 'Param', string4,
         string5,
         string0, string27, module_name, string1,
         string2, string27, module_name, string3, 'OutData', string4,
         string5)
